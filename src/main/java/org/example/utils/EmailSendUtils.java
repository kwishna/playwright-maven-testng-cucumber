...
public class EmailSendUtils {
    public static void sendEmail(int count_totalTCs, int count_passedTCs, int count_failedTCs, int count_skippedTCs) {
        ...
        String attachmentFile = Constants.EXTENT_REPORT_FOLDER_PATH;

        try {
            EmailAttachmentsSender.sendEmailWithAttachments(SERVER, PORT, FROM, PASSWORD, TO, EMAIL_SUBJECT, messageBody, attachmentFile);
